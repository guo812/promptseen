export const site = {
  ...
  gaId: 'G-HJ16WBEHPL',
  plausibleDomain: 'promptseen.online',
  gscVerification: 'oqDRZvU4iMX3oK_xBsTGEGLJ11PrPYFWWDrK_yd2Srs',
} as const;
...
export const prompts: Prompt[] = [
  ...
  {
    title: '2026 Collectible Action Figure Box',
    market: 'Global',
    tag: 'Trending',
    tool: 'ChatGPT',
    useCase: 'Viral toy package edit',
    prompt: 'Turn the person in my uploaded photo into a generic collectible action figure sealed inside clear blister packaging. Preserve the face, hairstyle, body shape, outfit colors, and recognizable accessories. Use glossy molded plastic texture, premium studio lighting, a clean retail product-photo background, and 2-3 hobby accessories beside the figure. Add no real brand names, no logos, no celebrity references, and no readable text. Square 1:1 composition for Instagram.',
    image: '/assets/prompt-scenes/trend-action-figure-2026.png',
    imageAlt: 'Generic collectible action figure packaging AI photo prompt thumbnail for 2026 social trend',
  },
  {
    title: 'AI Polaroid Memory Frame',
    market: 'Global',
    tag: 'Trending',
    tool: 'Gemini',
    useCase: 'Nostalgic feed post',
    prompt: 'Transform this photo into a vintage instant-film snapshot from the late 1990s. Keep the subject recognizable, add a thick white instant-photo border with extra space at the bottom, hard on-camera flash, warm faded colors, fine film grain, slight softness, edge falloff, and a candid unposed memory feeling. Do not include celebrities or people without consent. 4:5 Instagram crop.',
    image: '/assets/prompt-scenes/trend-polaroid-2026.png',
    imageAlt: 'Vintage AI Polaroid memory prompt thumbnail with instant film borders and warm flash',
  },
  {
    title: 'Y2K Camcorder Flash Edit',
    market: 'Global',
    tag: 'Trending',
    tool: 'Any AI image tool',
    useCase: 'TikTok or Reels cover',
    prompt: 'Edit my photo like a chaotic early-2000s camcorder still. Preserve my face and main outfit, add direct flash overexposure, cool indoor lighting, low-resolution VHS texture, subtle scanlines, small timestamp-style graphic shapes without readable text, slight motion blur, and a casual party snapshot mood. Use vertical 9:16 composition for TikTok, Reels, or Stories.',
    image: '/assets/prompt-scenes/trend-y2k-camcorder-2026.png',
    imageAlt: 'Y2K camcorder AI photo prompt thumbnail with VHS scanlines and direct flash',
  },
  {
    title: 'Scrapbook Digital Journal Collage',
    market: 'Global',
    tag: 'Trending',
    tool: 'ChatGPT',
    useCase: 'Pinterest-style carousel',
    prompt: 'Turn this photo into a handmade scrapbook journal collage. Keep the person recognizable, layer torn notebook paper, tape pieces, soft stickers, pressed flowers, faded magazine cutouts, doodle-like shapes, coffee-stain texture, and pastel color grading around the image. Make it feel tactile and personal, not polished AI. No readable fake handwriting or brand logos. 4:5 Instagram feed composition.',
    image: '/assets/prompt-scenes/trend-scrapbook-2026.png',
    imageAlt: 'Scrapbook digital journal AI prompt thumbnail with torn paper and pastel textures',
  },
  {
    title: 'Text-Free Indie Movie Poster',
    market: 'Global',
    tag: 'Trending',
    tool: 'ChatGPT',
    useCase: 'Cinematic poster edit',
    prompt: 'Create a dramatic indie movie-poster style image from this portrait while preserving identity. Use cinematic shadows, subtle film grain, moody editorial color grading, atmospheric background depth, elegant negative space, and a powerful main-character expression. Do not add title text, actor names, critic quotes, studio logos, or copyrighted movie references. 2:3 poster composition.',
    image: '/assets/prompt-scenes/trend-movie-poster-2026.png',
    imageAlt: 'Text-free indie movie poster AI photo prompt thumbnail with moody cinematic lighting',
  },
  {
    title: '1980s Neon Time Travel Portrait',
    market: 'Global',
    tag: 'Trending',
    tool: 'Gemini',
    useCase: 'Storytelling creator post',
    prompt: 'Place the person from my photo into a rainy 1980s neon city street at night. Preserve the face and natural proportions, adapt the outfit into era-appropriate retro streetwear, add glowing shop signs without readable text, wet pavement reflections, cinematic fog, realistic shadows, film-grain texture, and teal-magenta color grading. Use 4:5 vertical Instagram composition.',
    image: '/assets/prompt-scenes/trend-time-travel-2026.png',
    imageAlt: '1980s neon time travel AI portrait prompt thumbnail with rainy city reflections',
  },
  {
    title: 'Warm LED Mirror Selfie Prompt',
    market: 'South Asia / Global',
    tag: 'Trending',
    tool: 'Gemini',
    useCase: 'Hyper-real selfie edit',
    prompt: 'Use my uploaded photo as a strict identity reference and create a realistic mirror selfie in a clean modern room. Preserve my face, hairstyle, skin tone, and body proportions. Add a warm LED arch mirror glow, stylish but believable outfit, phone-camera realism, natural skin texture, slight background blur, soft indoor shadows, and a casual confident pose. No brand logos, no fake text, 3:4 portrait crop.',
    image: '/assets/prompt-scenes/trend-mirror-selfie-2026.png',
    imageAlt: 'Warm LED mirror selfie AI prompt thumbnail for realistic Gemini-style portrait edits',
  },
  {
    title: 'Cinematic Monsoon Rain Portrait',
    market: 'South Asia / Global',
    tag: 'Trending',
    tool: 'ChatGPT',
    useCase: 'Rainy couple or solo edit',
    prompt: 'Transform this photo into a cinematic monsoon rain portrait. Preserve every visible person’s identity, add umbrellas or rain-soaked street atmosphere only if it fits the pose, warm street lights, wet pavement reflections, soft rim light, natural skin texture, realistic fabric detail, cozy emotional mood, and subtle film grain. Avoid fake logos or readable text. 4:5 Instagram composition.',
    image: '/assets/prompt-scenes/trend-monsoon-2026.png',
    imageAlt: 'Cinematic monsoon rain AI photo prompt thumbnail with umbrellas and warm street lights',
  },
...
export const legalPages = {
  'privacy-policy': {
    ...
    body: [
      ...
      'When analytics consent is accepted, we may load Plausible Analytics for promptseen.online, Google Analytics 4 (measurement ID G-HJ16WBEHPL), and Microsoft Clarity (project ID x0vmlezgsz). These providers may process page views, interaction events, device data, approximate location, session behavior, heatmaps, outbound-link or file-download analytics, and similar analytics information under their own policies. Analytics scripts are not intentionally loaded before consent.',
...
export const extraLegalPages = {
  'cookie-policy': {
    ...
    body: [
      ...
      'Analytics cookies and scripts are optional. If you accept analytics, PromptSeen may load Plausible Analytics for promptseen.online, Google Analytics 4 (G-HJ16WBEHPL), which can set cookies such as _ga, _gid, and _gat, and Microsoft Clarity (x0vmlezgsz), which can set or use identifiers such as _clck, _clsk, CLID, and MUID for pageview, behavior, heatmap, outbound-link, file-download, and session-quality measurement.',
      'Plausible, GA4, and Clarity are not intentionally loaded until you choose “Accept analytics” in the banner. If you choose “Reject analytics,” PromptSeen stores that choice and continues to load only essential and functional storage needed for the website.',
